# codex-dev-flow-skill Specification

## Purpose
Define how the bundled `dev-flow` Codex Skill and existing STDIO MCP server are
packaged, discovered, validated, documented, and kept within Controller-owned
